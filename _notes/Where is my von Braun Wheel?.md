...
# What is a vBW?
Early space visionaries, such as Werner von Braun, strongly believed that settling the solar system required developing technologies to generate artificial gravity within orbiting habitats as- rephrasing [Heinlein](https://en.wikipedia.org/wiki/The_Moon_Is_a_Harsh_Mistress)- space is a harsh mistress. Modern-day astronauts spend [a few hours each day exercising](https://www.nasa.gov/wp-content/uploads/2015/05/167746main_fs_livingandworkinginspace508c.pdf) to overcome [microgravity](https://en.wikipedia.org/wiki/Weightlessness)'s effects on [the body](https://www.nature.com/articles/s41526-020-0095-y) such as [muscle atrophy](https://www.nature.com/articles/s41526-021-00158-4), [bone loss](https://www.nature.com/articles/s41526-020-0103-2), and [vision problems](https://www.nature.com/articles/d41586-025-00654-7#:~:text=Spending%20long%20periods%20in%20the,that%20change%20how%20the%20eye). von Braun was convinced that his solution to this problem, the rotating-wheel space station, was ['as inevitable as the rising sun’](https://www.nasa.gov/humans-in-space/space-stations/); they appeared in his 1949 sci-fi novel, “[Project Mars](https://en.wikipedia.org/wiki/Project_Mars:_A_Technical_Tale)”, where humans reached the red planet in such stations and, in 1956, Disney worked with him to create the first moving visuals of such a “[von Braun wheel](https://www.youtube.com/watch?v=5JJL8CUfF-o)” . In these systems, humans live along the periphery of a spinning wheel, within which they experience gravity. Popularised by von Braun, the concept actually traces back to [Herman Potočnik](https://en.wikipedia.org/wiki/Herman_Poto%C4%8Dnik#The_Problem_of_Space_Travel)'s 1929 book [_The Problem of Space Travel_](https://www.dlib.si/details/URN:NBN:SI:DOC-QK9YC09U). The legacy of the idea is probably why many felt that an operational station was, at best, a couple decades away.
...
Made from soft materials, like rubber and nylon, there were concerns that collisions with micrometeorites could puncture the station with fatal outcomes. So, a six-month contract in 1961 was awarded to North American Aviation to look into hexagonal space stations made from hinge-connected rigid pipes based on one of Rene Berglund's many station concepts. His design folded neatly into a rocket for launch and automatically deploy in-orbit and the rigidity of its habitable elements offered better protection to micrometeoroid collisions than Goodyear's rubber donut. It did so by incorporating air-lock doors that sealed if any threat arose to the integrity of the interconnecting inflatable tubes leading to its central hub. A 15-foot prototype of the system was developed, based on the table-top concept shown below. The hexagonal station emerged as the leading concept at Langley's Manned Space Laboratory Research Group; it was estimated that either system could be realised for $100 million (approximately a billion dollars in 2025).
...
Things would change from May 1961, when President Kennedy's landmark speech committed America to a lunar landing instead of merely orbiting the moon, as originally planned. This would effectively sideline the space station projects over the next year. The methodical approach envisioned by Loftin and von Braun to use a station as a staging point for lunar missions was bypassed in favor of a direct path to the Moon. The space station program survived only through Langley's persistent lobbying, which positioned larger stations as "the next logical step" after Apollo. However, by 1963, the vision shrank dramatically to accommodate Apollo's more modest needs: zero gravity environments and crews of three rather than the 36 astronauts envisioned for the rotating hexagon. This work was pursued under the Manned Orbiting Research Laboratory (MORL) program; much of this work fed into the development of Skylab.

Elsewhere, a parallel challenge was emerging within NASA's organizational structure. Wernher von Braun's Saturn rocket team at Marshall Space Flight Center, which was developing the powerful launchers needed for lunar missions, knew that his center would soon face layoffs while other centers actively prepared for the first Moon landing. This was a problem created by George E. Mueller, NASA's Associate Administrator for Manned Space Flight, who gambled on the revolutionary "all-up testing"  to accelerate the Saturn development path. Mueller had previously seen the success of this approach in the Minuteman ICBM program, where missiles flew with all stages active on their very first test. Mueller's gamble on using this approach on much larger space rockets paid off when Apollo 8 orbited the Moon on just the third Saturn V launch in December 1968. But Mueller understood that this efficiency threatened von Braun's team. To pre-empt post-Apollo planning needs and von Braun's staffing concerns, Mueller established a Saturn-Apollo Applications Program Office in 1965. This program, in theory, fused with Langley's early space station work; in 1967, the MORL concept was studied as both an Earth-orbiting station and a vessel for a crewed Mars trip whereas Marshall looked into two Earth-orbiting stations for astronomy and biological research. Heppenheimer says that these space station studies only went ahead because of the interests of the directors of the centers conducting them but lacked any support from NASA Headquarters.

This is evident from how budgets played out – Mueller hoped Apollo Applications would secure $450 million in 1967 and over $1 billion anticipated for FY 1968. Reality proved far harsher. The Bureau of the Budget slashed the FY 1967 request to a mere $42 million and
