...
The commercial potential for crewed rotating space stations is gaining attention once again. [Jed McCaleb founder of Vast](https://www.vastspace.com/team#:~:text=Leadership-,Jed%C2%A0McCaleb,-Founder%2C%20Board%20Chair), one of the fast-moving companies aiming to build one, echoes von Braun that artificial gravity stations would be useful for Mars transport as they’d be '[much nicer to live on than inside Starship](https://www.youtube.com/watch?v=jj5NlK1_gFI&t=2150s)’ and sees [it as essential for humans living in space beyond a year](https://youtu.be/jj5NlK1_gFI?si=l0drrn9R2DDHbW5g&t=2479). This makes sense as Starship's Mars transit could range from months to years, depending on when launches occur.

Vast are currently developing smaller zero-gravity [Haven](https://www.vastspace.com/haven-1) [stations](https://www.vastspace.com/haven-2) but their [2035 plan](https://www.vastspace.com/roadmap#:~:text=2035%3A%20Artificial%20Gravity%C2%A0Station) is for an artificial gravity station in the shape of a long spinning stick station; think of its motion as that of a two-bladed fan. The limiting feature of this design is that any gravity will only be at the very ends of the stick. In part, this is because their stations rely on the post-Apollo approach of sending the space station up bit by bit as rigid modules.

![Vast's artificial gravity station aims to launch by 2035.](assets/imgs/vast-AGS.png)
...
While volume is useful in evaluating comfort in zero-gravity stations, where every bit of height is useful, it is meaningless once an artificial gravity station is in orbit. Then, floor area per astronaut is more relevant- same as used to measure spaciousness and capaciousness of homes and lab spaces on Earth. But determining this is currently hard as it requires much clearer “floor plans" of the interiors of a space station- and these are in scant supply (or at least not publicly available).

That said, space station manufacturers are rightly concerned with volumes as they are upstream of  areas large enough for even bigger crews to live and work in. Hence the the battle to pack larger volumes as compactly as possible into a rocket. This makes it imperative to develop inflatable space stations to fully understand the benefits.

This highlights that the Langley team's idea to stuff an inflatable tyre into a rocket was ahead of its time when compared to the hexagonal station. The difference is like carrying a packed tent in a backpack versus trying to fit in a [pre-fabricated home](https://en.wikipedia.org/wiki/Prefabricated_home)— the former is more mass and volume efficient whereas the latter is going to require either a bigger backpack or many smaller ones. Compared to backpacks, rockets are far more expensive, financially and environmentally.
But without advanced high strength fabrics to ensure astronauts' safety, the rigid concept was always going to be the victor, even if it packed less efficiently.

50 years since Langley's counterintuitive idea to live in inflatable donuts, the idea is finally seeing  traction while dispelling earlier concerns about safety as myths. The [Bigelow Expandable Module (BEAM)](https://en.wikipedia.org/wiki/Bigelow_Expandable_Activity_Module), a small inflatable module, was added to the ISS in 2016 based on an earlier NASA technology development program, [TransHAB](https://en.wikipedia.org/wiki/TransHab), from the 1990s. BEAM is made from high strength fabrics, like [Vectran](https://en.wikipedia.org/wiki/Vectran#:~:text=Vectran%20is%20a%20key%20component%20of%20a%20line%20of%20inflatable%20spacecraft%20developed%20by%20Bigelow%20Aerospace%2C%5B6%5D%20not%20only%20on%20two%20stations%20which%20are%20in%20orbit%5B7%5D%5B8%5D%20but%20also%20the%20Bigelow%20Expandable%20Activity%20Module%20which%20NASA%20is%20testing%20for%20its%20radiation%20shielding%20and%20thermal%20control%20capabilities), and has [proven stronger to colliding micrometeorites and orbital debris than the other metallic modules of the ISS](https://www.researchgate.net/profile/Douglas-Litteken/publication/333919095_System_Integration_Comparison_Between_Inflatable_and_Metallic_Spacecraft_Structures/links/5e75387392851cf2719a389c/System-Integration-Comparison-Between-Inflatable-and-Metallic-Spacecraft-Structures.pdf?__cf_chl_tk=pDGvn9SayN3u94_S2IxijTtcfUUkhKg0khQn23ldwPY-1735002576-1.0.1.1-tXvyxaLfG.lXVagYY.rMLfOHHkqRP9DP3HAh.jXshUY). Bigelow had also claimed the module offered [superior protection from radiation and thermal management](https://arstechnica.com/science/2017/05/the-future-nasa-uses-3d-printing-to-test-its-new-expandable-habitat/#:~:text=Bigelow%20officials%20have%20said%20the%20company%27s%20inflatable%20habitats%20should%20be%20as%20good%20as%2C%20or%20better%20than%2C%20the%20space%20station%20in%20terms%20of%20limiting%20radiation).
