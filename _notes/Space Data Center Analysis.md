...
Launch costs are calculated from launch numbers and determining this requires the design specifications of the system (mass and geometry). As I read the whitepaper, it was unclear how their system's total mass was going to be 100 tonnes (or 167 tonnes) as Starcloud haven't publicly shared their mass breakdown or component-level design documentation—it is either proprietary information or they are still figuring this out. But as it is hard to verify their mass claims, I thought I would try to unpack this for myself.
